...
export function SectionServices() {
  return (
    <section className="relative w-full h-[965px] ">
        ...
        <div className="flex-1 max-w-[594px] pt-32">
          ...
          <ul className="flex flex-col items-start gap-9">
            ...
            <li className="flex items-center gap-9 pb-9">
              <div className="w-7 h-7 flex items-center justify-center">
                <Image src={SoluctionsIcon} alt="Icone Phone" />
              </div>

              <p className="flex-1 text-txt-gray pr-2">
                Soluções de emprëstimos e renegociação para organizar suas
                finanças
              </p>
            </li>
            ...
            <li className="flex items-center gap-9 pb-9">
              <div className="w-7 h-7 flex items-center justify-center">
                <Image src={OptionsIcon} alt="Icone Phone" />
              </div>
            ...
            <li className="flex items-center gap-9 pb-9 border-b-[1px] border-primary-gray">
              <div className="w-7 h-7 flex">
                <Image src={CardIcon} alt="Icone Phone" />
              </div>

              <p className="flex-1 text-txt-gray pr-2">
                Acompanhe a fatura do seu cartão de crádito e faça compras
      ...
      <div className="absolute top-0 right-0 w-[32%] h-full bg-gray-phone">
        <Image
          src={ImagePhone}
          alt="Image Phone"
